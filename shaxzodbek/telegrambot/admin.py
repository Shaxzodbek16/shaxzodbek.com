...
class TelegramUserAdmin(admin.ModelAdmin):
    list_display = ('user_id', 'first_name', 'last_name', 'username',
                    'phone_number', 'created_at', 'command_count')
...
class UserCommandsAdmin(admin.ModelAdmin):
    list_display = ('id', 'get_user_name', 'command', 'truncated_response', 'created_at')
    list_filter = ('created_at', 'command', 'user_id')
    search_fields = ('user_id__first_name', 'user_id__last_name', 'user_id__username',
                     'command', 'response')
